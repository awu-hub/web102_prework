...
const numGamesString = numUnfundedGames === 1 ? " game remains" : " games remain";


// create a new DOM element containing the template string and append it to the description container
const displayString = "A total of $" + totalRaised.toLocaleString() + " has been raised for " + totalGames.toLocaleString() + 
    " games. Currently " + numUnfundedGames.toLocaleString() + numGamesString + " unfunded. We need your help to fund these amazing games!";
const descriptionElement = document.createElement("p");
descriptionElement.innerText = displayString;
